...
/**
 * Returns NodeCG's filtered config in a callback
 * @param {function} callback Callback function receiving the config object
 */
NodeCG.prototype.getConfig = function(callback) {
    if (this._config === null) {
        setTimeout(this.getConfig.bind(this, callback), 100);
    } else {
